...
function downloadLearningPlan() {
    ...
    const template = roleRoadmapTemplates[role] || roleRoadmapTemplates["Python Developer"];
    
    // Instead of randomly splitting missing skills, we use the actual roadmap phases
    const p1Skills = template.phase1;
    const p2Skills = template.phase2;
    const p3Skills = template.phase3;
    const p4Skills = template.phase4;
